...
function clone_repo() {
    if [[ -d "team_418" ]]; then
        ...
        rm -rf *
        wget https://github.com/Revivegodx/khomvpn/archive/refs/heads/main.zip
        unzip main.zip
        mv khomvpn-main/* .
        rm -rf khomvpn-main main.zip
		echo -e "\e[34m khomvpn repository has been cloned\e[0m"
    else
        wget https://github.com/Revivegodx/khomvpn/archive/refs/heads/main.zip
        unzip main.zip
        mkdir -p team_418
        mv khomvpn-main/* team_418/
        cd team_418 || exit
        rm -rf ../khomvpn-main ../testing.zip
		echo -e "\e[34m khomvpn repository has been cloned\e[0m"
    fi
}
